...
public class UpdateTeacher extends JFrame implements ActionListener {
   ...
   UpdateTeacher() {
      ...
      this.cEmpId.setBounds(250, 100, 200, 20);
      ...
      this.add(lblrollno);
      this.labelEmpId = new JLabel();
      this.labelEmpId.setBounds(200, 200, 200, 30);
      this.labelEmpId.setFont(new Font("Tahoma", 0, 18));
      ...
      try {
         ...
         while(rs.next()) {
            ...
            this.labelEmpId.setText(rs.getString("empId"));
            this.tfcourse.setText(rs.getString("education"));
            this.tfbranch.setText(rs.getString("department"));
         }
      } catch (Exception var24) {
         var24.printStackTrace();
      }

      this.cEmpId.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent ie) {
            try {
               Conn c = new Conn();
               String query = "select * from teacher where empId='" + UpdateTeacher.this.cEmpId.getSelectedItem() + "'";
               ResultSet rs = c.s.executeQuery(query);
               ...
               while(rs.next()) {
                  ...
                  labelfname.setText(rs.getString("fname"));
                  labeldob.setText(rs.getString("dob"));
                  UpdateTeacher.this.tfaddress.setText(rs.getString("address"));
                  UpdateTeacher.this.tfphone.setText(rs.getString("phone"));
                  UpdateTeacher.this.tfemail.setText(rs.getString("email"));
                  labelx.setText(rs.getString("class_x"));
                  labelxii.setText(rs.getString("class_xii"));
                  labelaadhar.setText(rs.getString("aadhar"));
                  UpdateTeacher.this.labelEmpId.setText(rs.getString("empId"));
                  UpdateTeacher.this.tfcourse.setText(rs.getString("education"));
                  UpdateTeacher.this.tfbranch.setText(rs.getString("department"));
               }
   ...
   public void actionPerformed(ActionEvent ae) {
      if (ae.getSource() == this.submit) {
         String empId = this.labelEmpId.getText();
